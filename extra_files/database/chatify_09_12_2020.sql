...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2020 at 01:36 PM
...
INSERT INTO `a1_users` (`id`, `name`, `email`, `contact`, `type`, `location`, `gender`, `birthdate`, `active_status`, `dark_mode`, `messenger_color`, `avatar`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `district_id`) VALUES
(1, 'test', 'test@gmail.com', '0', 'admin', 'Dhaka', 'male', '0000-00-00', 0, 1, '#ff2522', '6a4c3aae-24eb-4094-8f75-64c4333acdbc.jpg', NULL, '$2y$10$623.z6ZYn5EpGcrazhBvrOJf7kc8EelMeZuinVVfeTorqcDEEDndG', 'QTTQCu288BOqmOTJccFOPTuA4J2MBgA9hjA6msDqiGEIsQK188OvXvKSRLAC', '2020-10-13 23:07:11', '2020-10-13 23:08:20', 24),
(6, 'Name', 'name@gmail.com', '12312312312312', 'client', 'Dhaka', 'male', '1991-10-10', 0, 1, '#2180f3', '7220e681-0472-43b3-b9be-4bb3c23e6b79.jpg', NULL, '$2y$10$RCqWjlHhahV8fd3NhASskOKtNZ15eObOOzHRkc1iQk2wQr1UC9bpi', 'z6d0JvGqkEppg3rUeM1Q4lZp1DO9PFLPG6BRtsXd3RM8v6Zjp4Ql1kHL4OhE', '2020-10-14 06:50:55', '2020-11-05 05:18:17', 1),
(14, 'Test Lawyer', 'test_lawyer@gmail.com', '01705151515', 'lawyer', 'Khulna', 'male', '2000-01-10', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$gIqM.qv44Nc6PaDzU5VWKumP2v1lMhhQBgI2q.pkfbB0DTFZPh/oe', NULL, '2020-10-14 11:24:40', '2020-10-20 04:43:34', 55),
(15, 'lawyer2', 'lawyer2@gmail.com', '13412312312', 'lawyer', 'Barisal', 'male', '1909-09-09', 0, 1, '#ff2522', 'avatar.png', NULL, '$2y$10$zui3T4Qr2p3kiHtahkrPruZ8LxZgJ.REcFmEeXgyE8DkWH8RBvKtu', NULL, '2020-10-21 09:55:08', '2020-10-30 09:25:51', 23),
(16, 'client2', 'client2@gmail.com', '7236548132', 'client', 'Khulna', 'female', '1909-09-09', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$iGt7ZaafRT8ahEljuLbjj.897oMd13.W6uMbWbptoWIiHJiOLI8pK', NULL, '2020-10-21 09:55:46', '2020-10-21 09:55:46', 20),
(17, 'client3', 'client3@gmail.com', '4524457452757', 'client', 'Rangpur', 'male', '1999-10-10', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$sqjpU/uOFZg/I/FGgP4JLeAMgOO5aWsa.8WWDJCcxjESi.oZhutBe', NULL, '2020-11-04 23:53:01', '2020-11-04 23:53:01', 29),
(18, 'lawyer4', 'lawyer4@gmail.com', '5242442525424', 'lawyer', 'Sylhet', 'female', '1990-12-12', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$jTDaSxtoalVnf3GhVoz5quf0qedrj5VrfsOurL5JhtTnX9xEEiieO', NULL, '2020-11-04 23:53:50', '2020-11-04 23:53:50', 58),
(19, 'lawyer3', 'lawyer3@gmail.com', '45676767865785', 'lawyer', 'Mymensigh', 'male', '1999-09-09', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$tybSgWX5N/cxgfkPN8pV8emKza2UmLZJft9MIj6YQWsbZ8AnUGDGa', NULL, '2020-11-04 23:56:35', '2020-11-04 23:56:35', 36),
(20, 'abc', 'farhan.etolet@gmail.com', '111111111111', 'lawyer', 'qasdfasdasd', 'male', '1995-10-10', 0, 0, '#2180f3', 'avatar.png', NULL, '$2y$10$05pkoOA5fNWNqksaeJSWseHoo2XChmE.faVLf7HrH1kXcIXk4tRtS', NULL, '2020-12-05 08:40:37', '2020-12-05 08:40:37', 63);
...
CREATE TABLE `b2_casefiles` (
  ...
  `result` enum('waiting','pending','rejected','running','won','lost') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 'rfgerge-452', 'sdsdfnbwsghdfgbqwebdfkbwjef', 'family', 'prosecutor', 16, NULL, NULL, 'waiting', '2020-10-30 09:40:11', '2020-12-06 09:22:15'),
(5, 'kim-545', 'zczxczxczxc', 'family', 'defendant', 16, NULL, NULL, 'waiting', '2020-12-06 03:25:27', '2020-12-06 03:25:27'),
(6, 'asdfsdf', 'sdfsdf', 'family', 'prosecutor', 16, NULL, NULL, 'waiting', '2020-12-06 04:00:45', '2020-12-06 04:00:45'),
(7, 'asdas', 'asdasda', 'civil', 'prosecutor', 16, NULL, NULL, 'waiting', '2020-12-07 11:57:19', '2020-12-07 11:57:19'),
(8, 'sdfsd', 'sdfsdfs', 'civil', 'defendant', 16, NULL, NULL, 'waiting', '2020-12-07 11:57:26', '2020-12-07 11:57:26'),
(9, 'dim', 'asdasd', 'criminal', 'defendant', 17, NULL, NULL, 'waiting', '2020-12-07 13:11:45', '2020-12-07 13:11:45');
...
(5, NULL, 20, NULL, NULL, NULL, 0.00, 0, 0, 0.00, '2020-12-05 08:40:37', '2020-12-05 08:40:37');
...
CREATE TABLE `c1_requests` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `state` enum('waiting','accepted','rejected') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'waiting',
  `client_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `c1_requests` (`id`, `state`, `client_id`, `casefile_id`, `lawyer_id`, `created_at`, `updated_at`) VALUES
(1, 'rejected', 4, 9, 1, '2020-12-08 10:27:13', '2020-12-08 19:20:49'),
(2, 'accepted', 4, 9, 2, '2020-12-08 10:27:15', '2020-12-08 10:27:15'),
(3, 'rejected', 4, 9, 4, '2020-12-08 10:27:17', '2020-12-08 10:27:17');
...
(45, '2020_12_04_160055_create_cache_table', 6),
(46, '2020_12_07_063422_add_district_id_to_users_table', 7),
(48, '2020_12_07_095200_create_requests_table', 8);
...
--
ALTER TABLE `c1_requests`
  ADD CONSTRAINT `c1_requests_casefile_id_foreign` FOREIGN KEY (`casefile_id`) REFERENCES `b2_casefiles` (`id`),
  ADD CONSTRAINT `c1_requests_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `b7_clients` (`id`),
  ADD CONSTRAINT `c1_requests_lawyer_id_foreign` FOREIGN KEY (`lawyer_id`) REFERENCES `b6_lawyers` (`id`);
COMMIT;
